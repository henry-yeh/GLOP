...
@torch.no_grad()
def eval(subsets, coor, opts): # eval_batch_size, revision_len, revision_iters, no_aug
    '''
    evaluation for CSP should eliminate the dummy depot
    '''
    p_size = subsets.size(1)
    for subset in subsets:
        subset[subset == 0] = subset[0]
