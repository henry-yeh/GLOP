...
#             assert problem.NAME == "tsp", "Unsupported problem: {}".format(problem.NAME)
        ...
        self.decision_query_embedder = nn.Linear(1, 128)
        self.decision_ll1 = nn.Linear(128, 32)
        self.decision_ll2 = nn.Linear(32, 1)
        self.decision_ll3 = nn.Linear(20, 1)
    ...
    def forward(self, input, return_pi=False, decision_train=False):
        """
